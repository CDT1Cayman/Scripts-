...
public class World : MonoBehaviour
{
    ...
    void Awake()
	{
		...
		//cargar la posicion del jugador si esta guardada
		if (PlayerPrefs.HasKey("PlayerPosX") && PlayerPrefs.HasKey("PlayerPosY") && PlayerPrefs.HasKey("PlayerPosZ")) {
			...
			playerPos = new Vector3Int((int)posX, (int)posY, (int)posZ);

			//Establecer la posicion del jugador al valor guardado 
    ...
    public void SavePlayerPosition(Vector3Int position)
    {
	...
	void GenerateWorld()
	{
		...
		{
			loadingWorldInfo.text = "Cargando Mundo";
			loadingWorldInfoShadow.text = "Cargando Mundo";
		...
		loadingWorldInfo.text = "Generando Mundo";
		loadingWorldInfoShadow.text = "Generando Mundo";
		...
		for (int x = 0; x < worldBlockWidth; x++)
		{
			for (int y = 0; y < worldBlockHeight; y++)
			{
				for (int z = 0; z < worldBlockWidth; z++)
				{
					...
					// Tierra en lugar de arena
					if (sandBiome > 30)
					{
						if (noise > 0.1f)
						{
							world[x, y, z] = 6; // Cambiado de 6 (arena) a 1 (tierra)
						}
					...
					else
					{
						if (noise > 0.1f)
						{
							world[x, y, z] = 1; // Cambiado de 1 (tierra) a 3 (grava)
						}
	...
	{
		loadingWorldInfo.text = "Construyendo Terreno";
		loadingWorldInfoShadow.text = "Construyendo Terreno";
